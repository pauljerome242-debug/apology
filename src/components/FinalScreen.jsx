    ...
    <div className="flex-1 flex items-center justify-center relative px-10 py-20">
      ...
      >
        ...
        <h1 className="text-4xl font-semibold text-gray-700 mb-6">
          I really missed you, and I’m so sorry for everything 🥹💖
        </h1>

        <p className="text-2xl text-rose-600 mb-10">
          i'm truly sorry for what i did.you're everything to me and i never want to hurt you. please forgive me and love me again 🎉❤️
        </p>
